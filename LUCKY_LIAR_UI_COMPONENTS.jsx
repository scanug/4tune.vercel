/**
 * LUCKY LIAR - UI Components (Sezione 9.1)
 * Componenti per UI giocatore: mano, wildcard, crediti, card
 */
 ...
 */
export function PlayerHand({ cards, selectedIndex, onCardSelect, isMyTurn }) {
  return (
 ...
 */
export function WildcardStatus({ hasWildcard, state, onClick }) {
 ...
 */
export function CreditDisplay({ credits, changes = null, isHighlighted = false }) {
  const [displayCredits, setDisplayCredits] = useState(credits);
  const isPositive = credits >= 0;

  // Animazione cambio crediti
  useEffect(() => {
    if (changes !== null) {
...
// ============================================
// PLAYER CARD COMPONENT (Nella game view)
// ============================================

/**
 * Card di un giocatore nella vista di gioco
 * Mostra: nome, crediti, wildcard status, indicatori
 */
